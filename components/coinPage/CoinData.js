...
export const CoinData = ({ coin }) => {
  return (
    <div className="w-full h-full mb-4 bg-[#303030] rounded-2xl md:col-span-2 p-8 border-t-4 border-indigo-700">
      <div>
      ...
      <div className="w-full grid grid-cols-3 mt-12 gap-5 text-sm">
        <div>
